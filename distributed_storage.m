function varargout = distributed_storage(varargin)
% DISTRIBUTED_STORAGE MATLAB code for distributed_storage.fig
%      DISTRIBUTED_STORAGE, by itself, creates a new DISTRIBUTED_STORAGE or raises the existing
%      singleton*.
%
%      H = DISTRIBUTED_STORAGE returns the handle to a new DISTRIBUTED_STORAGE or the handle to
%      the existing singleton*.
%
%      DISTRIBUTED_STORAGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DISTRIBUTED_STORAGE.M with the given input arguments.
%
%      DISTRIBUTED_STORAGE('Property','Value',...) creates a new DISTRIBUTED_STORAGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before distributed_storage_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to distributed_storage_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @distributed_storage_OpeningFcn, ...
                   'gui_OutputFcn',  @distributed_storage_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before distributed_storage is made visible.
function distributed_storage_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to distributed_storage (see VARARGIN)

% Choose default command line output for distributed_storage
...
% UIWAIT makes distributed_storage wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = distributed_storage_OutputFcn(hObject, eventdata, handles) 
